...
export const developments: Development[] = [
  {
    ...
    heroImage: '/images/albert-collective/view-1.jpg',
    gallery: [
      '/images/albert-collective/view-1.jpg',
      '/images/albert-collective/view-2.jpg',
      '/images/albert-collective/view-3.jpg',
    ],
    floorPlans: [],
    description: [
    ...
    location: { lat: -36.89754, lng: 174.71797 },
    amenities: [
      'Moments from Ōwairaka District School',
      'Close to parks, playgrounds and green spaces',
      'Easy public transport connections',
      'Quick access to SH20 and the Northwestern Motorway',
      'Mt Albert Village and train station within easy reach',
      'Westfield St Lukes nearby for shopping and dining',
    ],
    suburbHighlights: [
  ...
  },
  {
    ...
    heroImage: '/images/hendon-rise/04.jpg',
    gallery: [
      '/images/hendon-rise/04.jpg',
      '/images/hendon-rise/01.jpg',
      '/images/hendon-rise/02.jpg',
      '/images/hendon-rise/03.jpg',
    ],
    floorPlans: [],
    description: [
      'This development comprises 18 architecturally designed townhouses, offering a mix of two- and three-bedroom homes. Featuring distinctive sawtooth rooflines, dedicated car parking, and thoughtfully planned layouts, each residence is designed for modern living, delivering style, functionality, and low-maintenance comfort.',
    ],
    sellingPoints: [],
    location: { lat: -36.89691, lng: 174.72041 },
    amenities: [
      'Close to Ōwairaka District School',
      'Surrounded by local parks and green spaces',
      'Cafes and shops within walking distance',
      'Easy bus connections towards the CBD',
      'Quick access to SH20 and the Northwestern Motorway',
      'Westfield St Lukes approx. 3km away',
    ],
    suburbHighlights: [],
  },
  {
