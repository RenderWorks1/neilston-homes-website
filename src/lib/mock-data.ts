...
export const developments: Development[] = [
  {
    ...
    heroImage: '/images/albert-collective/04.jpg',
    gallery: [
      '/images/albert-collective/04.jpg',
      '/images/albert-collective/01.jpg',
      '/images/albert-collective/02.jpg',
      '/images/albert-collective/03.jpg',
    ],
    floorPlans: [],
    description: [
    ...
    amenities: [
      'Zoned for Mount Albert Grammar School',
      'Westfield St Lukes & supermarkets nearby',
      'Cafés and dining along New North Road',
      'Ōwairaka / Mt Albert Domain walking trails',
      'Mt Albert train station & frequent buses',
      'Minutes to the CBD & Northwestern Motorway',
    ],
    suburbHighlights: [
  ...
  },
  {
    ...
    name: 'Hendon Rise',
    status: 'Available',
    buildPhase: 'Civil Works Underway',
    featured: true,
    order: 2,
    // NOTE: address/suburb inferred from the OW-53 resource-consent docs (Hendon Ave frontage,
    // 127 Richardson Rd, Ōwairaka) — confirm the exact street number before going live.
    address: 'Hendon Avenue, Ōwairaka',
    suburb: 'Ōwairaka',
    totalHomes: 18,
    homeType: 'Townhouses',
    bedrooms: '2 & 3',
    bathrooms: '',
    carParks: '',
    completionEstimate: 'TBC',
    heroImage: '/images/hendon-rise/view-1.jpg',
    gallery: [
      '/images/hendon-rise/view-1.jpg',
      '/images/hendon-rise/view-2.jpg',
      '/images/hendon-rise/view-3.jpg',
    ],
    floorPlans: [],
    // DRAFT copy — replace with client-approved description.
    description: [
      'Hendon Rise brings 18 thoughtfully designed two- and three-bedroom townhomes to Ōwairaka in central Auckland. With civil works now underway, these freehold homes are planned around practical, connected living, close to schools, parks, and transport.',
    ],
    sellingPoints: [],
    location: { lat: -36.8925, lng: 174.7155 },
    amenities: [
      'Close to Ōwairaka District School',
      'Ōwairaka / Mt Albert Domain nearby',
      'Murray Halberg & Underwood Parks close by',
      'Local shops and cafés on Richardson Road',
      'Quick access to SH20 & Northwestern Motorway',
      'Frequent bus routes to the CBD',
    ],
    suburbHighlights: [],
  },
  {
    ...
    heroImage: '/images/summit-views-stage2/drone.jpg',
    gallery: [
    ...
    floorPlans: [
      { label: 'Type A — 2 Bedroom', image: '/images/summit-views-stage2/5.jpg' },
      { label: 'Type B — 3 Bedroom', image: '/images/summit-views-stage2/6.jpg' },
    ],
    description: [
    ...
    suburbHighlights: [
      'Mount Albert is a leafy, central Auckland suburb beloved for its village feel and exceptional schools. Sitting in the shadow of Ōwairaka, it offers easy access to walking trails, parks and reserves, while Mt Albert Grammar, Marist College and Gladstone Primary anchor one of the most sought-after school zones in the city.',
      'Cafés along New North Road, weekends at Westfield St Lukes, and quick commutes via the Mt Albert train station or the Northwestern Motorway make daily life simple. Close to the CBD, but never lost in it.',
    ],
    order: 3,
  },
  {
    ...
    heroImage: '/images/summit-views-stage1/17.png',
    gallery: [
    ...
    floorPlans: [
      { label: 'Type A — 2 Bedroom', image: '/images/summit-views-stage1/19.png' },
      { label: 'Type B — 3 Bedroom', image: '/images/summit-views-stage1/20.png' },
    ],
    description: [
  ...
  },
  {
    ...
    heroImage: '/images/molly-green-edge/DRONE.jpg',
    gallery: [
  ...
  },
  {
    ...
    heroImage: '/images/the-balfron/drone.jpg',
    gallery: [
  ...
  },
  {
    ...
    heroImage: '/images/mountainview/a_18.jpg',
    gallery: [
      '/images/mountainview/a_01.jpg',
      '/images/mountainview/a_02.jpg',
      '/images/mountainview/a_10.jpg',
      '/images/mountainview/a_11.jpg',
      '/images/mountainview/a_18.jpg',
      '/images/mountainview/a_22.jpg',
      '/images/mountainview/a_24.jpg',
      '/images/mountainview/a_35.jpg',
      '/images/mountainview/a_37.jpg',
      '/images/mountainview/a_43.jpg',
    ],
    floorPlans: [{ label: '3 Bedroom Terrace', image: '/images/mountainview/a_22.jpg' }],
    description: [
      'Mountain View was a flagship Mount Roskill development of twenty-five terrace homes spanning the corners of Balfron Avenue, Freeland Avenue and Huakaroro Road, delivered one month ahead of schedule.',
    ],
    sellingPoints: [
  ...
  },
  {
    ...
    heroImage: '/images/owairaka-range/1.jpg',
    gallery: [
      '/images/owairaka-range/1.jpg',
      '/images/owairaka-range/2.jpg',
      '/images/owairaka-range/3.jpg',
      '/images/owairaka-range/4.jpg',
      '/images/owairaka-range/5.jpg',
      '/images/owairaka-range/6.jpg',
      '/images/owairaka-range/7.jpg',
      '/images/owairaka-range/8.jpg',
    ],
    floorPlans: [{ label: '3 Bedroom Terrace', image: '/images/owairaka-range/4.jpg' }],
    description: [
  ...
  },
  {
    ...
    heroImage: '/images/on-the-park/1.jpg',
    gallery: [
      '/images/on-the-park/1.jpg',
      '/images/on-the-park/2.jpg',
      '/images/on-the-park/3.jpg',
      '/images/on-the-park/4.jpg',
      '/images/on-the-park/5.jpg',
      '/images/on-the-park/6.jpg',
    ],
    floorPlans: [{ label: '3 Bedroom Terrace', image: '/images/on-the-park/4.jpg' }],
    description: [
  ...
  },
  {
    ...
    actualCompletion: 'December 2022',
    heroImage: '/images/the-gallery/1.jpg',
    gallery: [
      '/images/the-gallery/1.jpg',
      '/images/the-gallery/2.jpg',
      '/images/the-gallery/3.jpg',
    ],
    floorPlans: [{ label: '3 Bedroom Terrace', image: '/images/the-gallery/2.jpg' }],
    description: [
  ...
  },
  {
    ...
    heroImage: '/images/parkside/6.jpg',
    gallery: [
      '/images/parkside/1.jpg',
      '/images/parkside/2.jpg',
      '/images/parkside/3.jpg',
      '/images/parkside/4.jpg',
      '/images/parkside/5.jpg',
      '/images/parkside/6.jpg',
      '/images/parkside/7.jpg',
    ],
    floorPlans: [{ label: '3 Bedroom Terrace', image: '/images/parkside/4.jpg' }],
    description: [
      'ParkSide was an early Neilston Homes project of five terrace homes on Kotero Road, Mount Roskill.',
    ],
    sellingPoints: [
      'Mount Roskill location',
      'Master Build 10-year structural warranty',
...
export const teamMembers: TeamMember[] = [
  {
    ...
    bio: 'Tony previously led the company that built the first home in Hobsonville Point and was instrumental in developing the Axis affordable terraced housing model. With decades of experience in residential development, he has played a significant role in delivering high-quality, attainable housing across Auckland.\n\nAs Founder and Director of Neilston Homes, Tony provides strategic leadership and guides the company’s vision, ensuring every development reflects Neilston’s commitment to quality, value, and creating opportunities for people to own their future.',
    photo: '/images/teampics/TonyHouston.jpg',
    order: 1,
  },
  {
    name: 'Gerard Costello',
    role: 'Director and General Manager',
    bio: 'Gerard brings more than 22 years of experience in the property industry across New Zealand, Australia, and the United Kingdom. He has been involved in the delivery of over 1,200 homes, including a significant contribution to the development of Hobsonville Point, where more than half of those homes were built.\n\nAt Neilston Homes, Gerard oversees development and project delivery, helping transform underutilised sites into thriving communities. He is passionate about creating quality homes that give Aucklanders the opportunity to own their future.',
    photo: '/images/teampics/GerardCostello.jpg',
    order: 2,
  },
  {
    name: 'Sara Daji',
    role: 'Operations Manager',
    bio: 'Sara brings more than 20 years of experience across sales, marketing, customer service, finance, and business operations. With a strong background in process improvement, financial management, and customer experience, she plays a key role in ensuring the smooth operation and continued growth of the business.\n\nAs Operations Manager at Neilston Homes, Sara oversees sales, marketing, finance, customer care, and business performance initiatives. She is passionate about creating a seamless home-buying journey and takes pride in helping customers achieve home ownership while continually improving the systems and processes that support the business. Her favourite part of the role is handover day, where she gets to share in the excitement of customers receiving the keys to their new home.',
    photo: '/images/teampics/SaraDaji.jpg',
    order: 3,
  },
  {
    name: 'Matt Wootton',
    role: 'Construction Manager',
    bio: 'Matt brings over 23 years of experience in the construction industry across New Zealand and Australia. Starting his career on the tools before moving into management, he has played a key role in the delivery of more than 500 homes throughout his career.\n\nAt Neilston Homes, Matt leads the construction team, overseeing projects from planning through to completion. Known for his practical approach and commitment to quality, he works closely with consultants, subcontractors, and suppliers to ensure every home is delivered to a high standard.',
    photo: '/images/teampics/MattWootton.jpg',
    order: 4,
  },
];
